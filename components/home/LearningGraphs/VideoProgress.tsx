// components/home/LearningGraphs/VideoProgress.tsx
    ...
    <View style={styles.container}>
      <Svg width={GRAPH_WIDTH} height={GRAPH_HEIGHT}>
        ...
        <Path
          ...
          stroke={Colors.progressChart.video}
          strokeWidth="2"
          fill="none"
        />
        ...
        {valuePoints.map((point, i) => (
          <Circle
            ...
            cy={point.y}
            r="4"
            fill={Colors.progressChart.video}
          />
        ))}
      ...
      <View style={styles.legend}>
        <View style={styles.legendItem}>
          <View style={[styles.legendDot, { backgroundColor: Colors.progressChart.video }]} />
